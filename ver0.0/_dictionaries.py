...
class LMP_dics():
    def __init__(self):
        ...
        chem_pot_water=-15.31   #38.10*kJ_to_kcal
        chem_pot_salt=-310.5    #*thermal # 298.15 K
        ...
        self.dic_mc={
            "ref"           : "Luc Belloni, J. Chem. Phys. 149, 094111 (2018)",
            "gcmc"          : True,         # if True, no move is accepted, but measure chemical potential
            ...
            "bias"          :{              # for an ion-pair exchange
                "bias_f"    : "bimodal",
                "alpha"     : 0.01,          # inverse of width
                "center"    : 4.0,          # two center of bimodal
            ...
            "prob_water"    : 1.,           # electrolytes
            "prob_lj"       : 0.,           # simple lj solvent
            "prob_salt"     : 0.,           # electrolytes
            ...
            'neqMD':{
                ...
                'neq':{
                    ...
                    "altitude_protocol":{
                        ...
                        "screening_sr": 0.,     # coulomb screening along altitude
                ...
                'thermo_freq': 3000, #30,
                'neigh_freq': 10,
                'style': 'lj/cut/coul/ewaldneq/neq',
                'ensemble': 'rigid/nve',
                'dump': { 
                    'flag': False,
                    'atom': "all",
