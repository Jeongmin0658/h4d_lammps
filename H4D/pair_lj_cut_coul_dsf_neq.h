...
#ifdef PAIR_CLASS
// clang-format off
PairStyle(lj/cut/coul/dsf/neq,PairLJCutCoulDSFNeq);
// clang-format on
#else

#ifndef LMP_PAIR_LJ_CUT_COUL_DSF_NEQ_H
#define LMP_PAIR_LJ_CUT_COUL_DSF_NEQ_H

#include "pair.h"

namespace LAMMPS_NS {

class PairLJCutCoulDSFNeq : public Pair {
 public:
  PairLJCutCoulDSFNeq(class LAMMPS *);
  ~PairLJCutCoulDSFNeq();
