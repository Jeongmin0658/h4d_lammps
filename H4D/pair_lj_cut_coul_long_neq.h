...
#ifdef PAIR_CLASS
// clang-format off
PairStyle(lj/cut/coul/long/neq,PairLJCutCoulLongNeq);
// clang-format on
#else

#ifndef LMP_PAIR_LJ_CUT_COUL_LONG_NEQ_H
#define LMP_PAIR_LJ_CUT_COUL_LONG_NEQ_H

#include "pair.h"

namespace LAMMPS_NS {

class PairLJCutCoulLongNeq : public Pair {

 public:
  PairLJCutCoulLongNeq(class LAMMPS *);
  virtual ~PairLJCutCoulLongNeq();
 ...
 protected:
  ...
  double max2_altitude_neq, cut_coulsq_flying;
