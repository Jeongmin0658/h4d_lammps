...
class LMP_dics():
    def __init__(self):
        ...
        self.dic_mc={
            ...
            "gcmc"          : False,         # if False, no trial move is accepted, but measure chemical potential
            ...
            "prob_lj"       : 0.0,          # simple lj solvent
            "prob_salt"     : 1.0,          # electrolytes
            # probability of insertion (p_del = 1 - p_ins)
            "prob_insert"   : 1.0,          # for all ff; either 0.5 or 1 or 0
