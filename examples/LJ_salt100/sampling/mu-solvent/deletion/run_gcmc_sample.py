...
if __name__=="__main__":
        mycontrol.run_hneMDMC(
            save_freq=500,              # saving H4D outputs
            n_preMD=10000,              # number of steps in MD before GCMD
            n_MC_s=0,                   # no use this
            n_MC=5,                  # total number of MC attemps
            n_MC_each=10,               # number of particle-exchange attempts in a single MC step (sampling purpose)
            n_eqMD=400,                 # number of steps in equilibrium MD
            n_neqMD=100,                # number of stpes in NEMD
